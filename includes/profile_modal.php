    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Detalles de la Transacción</b></h4>
            </div>
            <div class="modal-body">
              <p>
                Día: <span id="date"></span>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">Celular</label>
                ...
                <div class="form-group">
                    <label for="curr_password" class="col-sm-3 control-label">Repetir Contraseña</label>
